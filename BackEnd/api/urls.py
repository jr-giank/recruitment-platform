...
urlpatterns = [
    ...
    path('vacantes/empresa/<int:pk>/', v.EmpresaView.as_view(), name='vacantes-empresa'),
    path('vacante/eliminar/guardada/<int:id_usuario>/<int:id_vacante>/', v.VacantesGuardadasView.as_view(), name='eliminar-vacante'),
    path('crear/solicitud/', v.SolicitudesView.as_view(), name='crear-solicitud'),
    path('obtener/categorias/', v.ObtenerCategoriasView.as_view(), name='obtener-categorias'),
    path('obtener/vacante/<int:pk>/', v.ObtenerVacanteView.as_view(), name='obtener-vacante'),
    path('obtener/vacantes/candidato/<int:pk>/', v.VacantesGuardadasView.as_view(), name='vacantes-guardadas-candidato'),
    path('solicitudes/vacante/<int:pk>/', v.SolicitudesView.as_view(), name='solicitudes-vacante'),
