...
urlpatterns = [
    ...
    path('solicitud/<int:id_solicitud>/', v.SolicitudesView.as_view(), name='actualizar-solicitud'),
    ...
    path('mensaje/<int:id_usuario>/', v.MensajesDestinosView.as_view(), name='obtener-mensaje'),
    path('categorias/', v.CategoriasView.as_view(), name='obtener-categorias'),
    path('prueba/', v.PruebaTecnicaView.as_view(), name='crear-prueba'),
