...
const VacancyGridAll = () => {
  ...
  return (
    ...
    <div className='w-full border-solid border-2 border-fifth rounded-md mt-5 mb-5 pl-4 pr-4 py-4 '>
        ...
        <Link className='flex justify-center cursor-pointer w-full mt-5 p-2 hover:bg-secondary border-solid border-2 border-eighth rounded' to='/candidates/viewSingleVacancy' >Ver vacante</Link>  
    </div>
